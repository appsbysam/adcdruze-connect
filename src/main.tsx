...
const RELEASE_NOTES = [
  "Fixed inactive Privacy Policy, Terms of Use and Account Settings rows in More.",
  "Account Settings now loads and saves member profile details.",
  "Notification preference switches now persist to the database instead of resetting on every visit.",
  "Member profile detail rows now open email, phone and map actions where appropriate.",
  "Removed an obsolete hard-coded version label from the More screen.",
  "Continued navigation audit across events, groups, businesses, notifications and volunteer flows.",
];
