...
import { ArrowLeft, Calendar, UsersRound, HeartHandshake, Briefcase, Megaphone, CheckCheck, Bell } from "lucide-react";
...
type NType = "event" | "committee" | "volunteer" | "business" | "announcement";
...
const meta: Record<NType, { icon: LucideIcon; color: string; soft: string; label: string }> = {
  ...
  committee: { icon: UsersRound, color: "var(--brand-groups)", soft: "var(--brand-groups-soft)", label: "Committee" },
